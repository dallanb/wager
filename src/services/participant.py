from ..models import Participant as ParticipantModel, ParticipantStatus as ParticipantStatusModel, ParticipantSchema, \
...
def dump_participant(participant, **kwargs):
    return ParticipantSchema().dump(participant, **kwargs)
